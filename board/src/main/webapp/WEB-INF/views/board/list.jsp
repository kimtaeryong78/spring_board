...
<script type="text/javascript">
	$(document).ready(function(){
		...
		/* 검색 결과가 없을 때의 처리*/
		if('<c:out value="${list}"/>'=='[]'){
			$(".modal-body").html("검색 결과가 없습니다.");
			$("#myModal").modal("show");
			$('#nullpoint').attr("hidden",null).addClass("text-center")
			.css("padding-bottom",50).css("padding-top",45).css("font-size",'1.5em').css("font-weight",'bold');
		}
	});
</script>
